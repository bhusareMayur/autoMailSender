...
const transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "Email Id",//your mail id
    pass: "password",//your password which is generated by google 16 char
  },
});
...
const connection = mysql.createConnection({
  ...
  database: "email_logs",//your database name
});
...
const sendEmail = (row) => {
  ...
  // Extract CSV data
  const mailOptions = {
    from: "Mayur Bhusare <user@gmail.com>",//your mail id
    to: EAddr,
